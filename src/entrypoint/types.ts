...
/**
 * A state override for the balance of an address
 */
export type BalanceStateOverride = Record<Address, { balance: Hex }>;

export type EntryPointStateOverride = Record<Address, { code: Hex }>;
