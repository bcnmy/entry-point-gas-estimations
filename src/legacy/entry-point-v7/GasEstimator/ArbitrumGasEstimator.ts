...
import { ARBITRUM_L1_FEE_GAS_PRICE_ORACLE_ABI } from "../../entry-point-v6";

/**
 * @remarks
 * ArbitrumGasEstimator class that extends GasEstimator and has estimation logic specific to Arbitrum
 */
