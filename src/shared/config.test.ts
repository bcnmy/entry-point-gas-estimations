...
describe("config-test", () => {
  ...
  const EIP1559SupportedNetworks = [
    1, 137, 42161, 10, 43114, 43113, 8453, 59144, 421614, 11155111, 84532,
    168587773, 81457, 42170, 169, 56400, 11155420, 80002, 27827, 4653, 100,
    10200, 997, 713715, 3799, 167009, 80084, 5845, 167000, 1328, 1329, 1715,
    995, 28882, 288, 920637907288165, 1740, 1750, 4202, 1135, 2818,
  ];
